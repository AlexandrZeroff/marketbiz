...
const Contacts = () => {
  return (
    <section id="contacts" className="p-default relative overflow-hidden">
      <img
        className="absolute bottom-12 -right-[60vw] hidden md:block"
        src={vector}
        alt=""
      ></img>
      <h1 className="uppercase text-center mt-8">Ready for the next step?</h1>
      <h2 className="mt-8 uppercase text-center md:text-left">
        Contact us today!
      </h2>
      <div className="flex flex-col items-center md:grid grid-cols-2 md:gap-16 lg:gap-24 xl:gap-32 md:pb-48">
        ...
        <div className="flex flex-col items-center my-16 md:mt-0 md:items-start">
          ...
          <a
            className="mt-2 text-center hover:text-th-secondary"
            href="tel:+60113454545"
          >
            +60 11 345 45 45
          </a>
          <a
            className="mt-2 text-center hover:text-th-secondary"
            href="mailto:marketbizbiz@com"
          >
            marketbizbiz@com
          </a>
        </div>
